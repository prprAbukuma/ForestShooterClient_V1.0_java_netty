...
public class PlayerAttack : MonoBehaviour {
    ...
    private void InstantiateArrow()
    {
        ...
        //:发送同步箭请求
        GameFacade.Instance.PlayerManager.PlayerSyncGo.GetComponent<SyncArrowRequest>().SendRequest(this.GetComponent<RoleInfo>().roleColor,arrow.transform.position,arrow.transform.eulerAngles);
    }
